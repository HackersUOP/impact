project_set = [
  {
    project_name: "name1",
    small_def:
      "small def small def small def small def small def small def small def small def",
    abstract:
      "small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def small def",
  ...
  },
  {
    ...
    small_def:
      "small def small def small def small def small def small def small def small def",
    abstract:
      "wqw32322535 qdsd f small def small def small def small def small def small def small def small def small def small ds ds  fnfnng  gfnsdmall def small def small def small def small def small def small def small def small def small def small def small def small def small def",
...
for (var i = 1; i <= project_set.length; i++) {
  $(".d-flex_project_list").append(
    '<div class="col-md-4 d-flex">' +
      ...
      '<a class="block-20" style="background-image: url(\'img/project_' +
      i +
      "/main.jpg');\">" +
      "</a>" +
      '<div class="text pt-4">' +
      '<h3 class="heading mt-2"><a>' +
      project_set[i - 1].project_name +
      "</a></h3>" +
      "<p>" +
      project_set[i - 1].small_def +
      "</p>" +
      "<center>" +
      '<div class="meta mb-3">' +
      "<div>" +
      ...
      '<a id="' +
      i +
      '" class="badge badge-info presentation_click">' +
      '<i id="' +
      i +
      '" class="fa fa-caret-square-o-left presentation_click" aria-hidden="true"></i> Presentaion' +
      "</a>" +
      "</span>" +
      "</button>" +
      "</div>" +
      ...
      '<a id="' +
      i +
      '" class="badge badge-warning abstract_click">' +
      '<i id="' +
      i +
      '" class="fa fa-file-text abstract_click" aria-hidden="true"></i> Abstract</a>' +
      "</span>" +
      "</button>" +
      "</div>" +
      "<div>" +
      ...
      '<a id="' +
      i +
      '" class="badge badge-danger project_link_click" data-toggle="modal" data-target="#project_div">' +
      '<i id="' +
      i +
      '" class="fa fa-info-circle project_link_click" aria-hidden="true"></i> more</a>' +
      "</span>" +
      "</button>" +
      "</div>" +
      "</div>" +
